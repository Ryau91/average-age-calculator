...
function completeForm(event) {
    ...
    const ageRowArray = Array.from(document.getElementsByClassName('table-row-age'));
    ...
    const sum = ageArray.reduce((accumulator, currentValue) => accumulator + currentValue)
    ...
    averageAgeToDisplay.innerHTML = mean
}
